...
export default {
  install: function(Vue, options) {
    ...
    var vm = new Vue({
      data: {
        host: 'http://192.168.1.48:8088', //'http://www.360unicom.cn/gxy',//'http://xhh.tunnel.qydev.com',//
    ...
    im.listen({
      ...
      onError: function(message) {
        ...
        if (im.errorType != WebIM.statusCode.WEBIM_CONNCTION_CLIENT_LOGOUT) {
          if (
            message.type === WebIM.statusCode.WEBIM_CONNECTION_ACCEPT_INVITATION_FROM_GROUP ||
